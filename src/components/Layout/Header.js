...
const Header = () => {
  ...
  return (
    <>
      ...
      <ModalBox open={showEndDayModal} close={setShowEndDayModal} className="md:w-[753px] bg-[#fff] rounded-xl py-3">
        <section className='py-10 px-7 md:px-28 md:py-16 flex flex-col items-center'>
        ...
        <div className='flex space-x-6 '>
          ...
          <div className='relative'>
            ...
            />
            {show && (
            <ul className=' h-[89px] w-[119px] absolute  right-0 mt-5 pt-2 bg-[#fff] text-center border border-slate-300 rounded-xl'
            >
