        ...
        <Layout>
            <section className='flex-1 h-auto md:h-[711px] bg-white rounded-[32px] px-8 py-8'>
                <div className='flex justify-between'>
                    <h1 className='font-medium text-[24px]'>Edit Category</h1>
                </div>
                <div className='w-full xl:w-[822px] mt-10'>
                    <form className=''>
                        ...
                        <div className='text-right'>
                            <button className='w-[199px] h-[48px] text-base text-white bg-primary rounded-xl font-light mt-4'>Update Product</button>
                        </div>
                    </form>
                </div>
            </section>
